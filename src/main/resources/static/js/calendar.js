...
Calendar.prototype.draw = function() {
	...
	_cs[_cs.length] = '  <th colspan="1"><input type="hidden"  class="b" name="clearButton" id="clearButton" \/><\/th>';
...
document.writeln('<div id="__calendarPanel" style="position:absolute;visibility:hidden;z-index:9999;background-color:#FFFFFF;border:1px solid #666666;width:210px;height:290px;">');
