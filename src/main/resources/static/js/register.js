...
function getAccountCountAJAX(account){
	var obj ;
	$.post(
  		"user/AccountCount.do",
  		{"account":account.val()},
  		function(data){
...
$('.inputbox').find('input').eq(3).change(function() {
...
$('.inputbox').find('input').eq(4).change(function() {
