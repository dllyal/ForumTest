				...
				<div class="thumbnail">
					...
					<div class="caption">
						...
						<div style="padding: 20px;">
							...
							<h3><span class="label label-default">板块添加</span></h3>
						
							<div class="page-header">
								<h1>新板块 <small>NEW</small></h1>					  	
							</div>
						
							<form id="jvForm" action="up/up.do" method="post" enctype="multipart/form-data">
								...
								<img id="mypic" src="<%=basePath%>img/defaultBlock.jpg" style="height: 150px;width: 450px;" class="img-rounded img-responsive" alt="头像">

								<p style="margin: 10px;"><button id="uploadpic" type="button" class="btn btn-primary btn-xs">点击选择更换图片</button></p>

							</form>

							<form action="admin/adminblockaddsave" method="post" onsubmit="return formcheck();">
							
							<input id="bpicsrc" readonly="readonly" type="hidden" name="bpicsrc" value="img/defaultBlock.jpg">
