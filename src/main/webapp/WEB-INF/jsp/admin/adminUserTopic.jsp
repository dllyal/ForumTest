				...
				<div class="thumbnail">
					...
					<div class="caption">
						...
						<div style="padding: 20px;">
							...
							<h3><span class="label label-default">用户的主题</span></h3>
							...
							<ul class="list-group">
							  	<c:if test="${p.pages!=0 }">
							  		<c:forEach items="${p.list }" var="topic">
							  			<li class="list-group-item">
											...
											<c:if test="${topic.state == 0}">
												<p class="text-right">
													<a href="javascript:deltopic(${topic.tid});" class="btn btn-danger btn-xs" role="button" >删除</a>&nbsp;&nbsp;&nbsp;&nbsp;
												</p>
											</c:if>
											<c:if test="${topic.state == 1}">
												<p class="text-right">
													<a href="javascript:retopic(${topic.tid});" class="btn btn-info btn-xs" role="button" >恢复</a>&nbsp;&nbsp;&nbsp;&nbsp;
												</p>
											</c:if>
									  	</li>
							  		</c:forEach>
							  		...
							  		<!-- 分页 -->
							  		<c:set var="pageUrl" value="admin/adminusertopic?uid=${uid }&page="></c:set>
